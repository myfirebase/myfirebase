<template>
    <div class="container">
        ...
        <p>This page was generated by the Firebase Command-Line Interface. To modify it, edit the
            <code>404.html</code> file in your project's configured public directory.</p>
...
export default {
    mounted() {
        // here where you can define which action should be taken while redirection
